...
class website_account(website_account):
    ...
    def account(self, **kw):
        ...
        tickets_count = request.env['helpdesk.ticket'].sudo().search_count(['|', '|', ('user_id', '=', user.id), ('partner_id', '=', user.partner_id.id), ('partner_id', 'child_of', user.partner_id.commercial_partner_id.id)])
    ...
    def my_helpdesk_tickets(self, page=1, date_begin=None, date_end=None, sortby=None, **kw):
        ...
        user = request.env.user
        domain = ['|', '|', ('user_id', '=', user.id), ('partner_id', '=', user.partner_id.id), ('partner_id', 'child_of', user.partner_id.commercial_partner_id.id)]
