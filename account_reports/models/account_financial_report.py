            ...
            sql = """WITH account_move_line AS (
              ...
              (
               ...
               SELECT aml.id, ref.date, aml.name,
                 ...
                 aml.amount_residual, aml.partner_id, aml.reconciled, aml.company_id, aml.company_currency_id, aml.amount_currency, aml.balance, aml.user_type_id, aml.tax_line_id, aml.invoice_id, aml.credit, aml.debit
