...
class TestUi(odoo.tests.HttpCase):
    def test_ui(self):
        self.phantom_js("/web", "odoo.__DEBUG__.services['web_tour.tour'].run('account_reports_widgets')", "odoo.__DEBUG__.services['web_tour.tour'].tours.account_reports_widgets.ready", login='admin')
