    ...
    def log_new_phonecall(self):
        ...
        return {
            ...
            'context': {'phonecall_id': phonecall.id,
                        ...
                        'default_opportunity_title_action': phonecall.opportunity_id.activity_summary,
                        'default_opportunity_date_action': phonecall.opportunity_id.activity_date_deadline,
