...
class HrAppraisal(models.Model):
    ...
    manager_appraisal = fields.Boolean(string='Manager Appraisal', help="This employee will be appraised by his managers")
    manager_ids = fields.Many2many('hr.employee', 'appraisal_manager_rel', 'hr_appraisal_id', string="Managers")
