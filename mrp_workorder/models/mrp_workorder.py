...
class MrpProductionWorkcenterLine(models.Model):
    ...
    component_tracking = fields.Selection(related='component_id.tracking', string='Component Tracking')
    ...
    component_uom_id = fields.Many2one(related='component_id.uom_id', string='Component Unit')
