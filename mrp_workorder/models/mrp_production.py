    ...
    def button_plan(self):
        ...
        for order in self:
            ...
            for workorder in order.workorder_ids:
                ...
                to_date = workcenter.calendar_id.attendance_ids and workcenter.calendar_id.plan_hours(workorder.duration_expected / 60.0, day_dt=from_date)
                if not to_date:
                ...
                if (workorder.operation_id.batch == 'no') or (workorder.operation_id.batch_size >= workorder.qty_production):
                    ...
                    to_date = workcenter.calendar_id.attendance_ids and workcenter.calendar_id.plan_hours(duration / 60.0, day_dt=from_date)
                    if not to_date:
