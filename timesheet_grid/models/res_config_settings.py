...
class ResConfigSettings(models.TransientModel):
    ...
    reminder_user_delay = fields.Integer("Number of days for User Reminder", related='company_id.timesheet_mail_employee_delay')
    reminder_user_interval = fields.Selection([
        ('weeks', 'after end of week'),
        ('months', 'after end of month')
    ], string='Frequency (for user)', required=True, related='company_id.timesheet_mail_employee_interval')
    ...
    reminder_manager_delay = fields.Integer("Number of days for Manager Reminder", related='company_id.timesheet_mail_manager_delay')
    reminder_manager_interval = fields.Selection([
        ('weeks', 'after end of week'),
        ('months', 'after end of month')
    ], string='Frequency (for manager)', required=True, related='company_id.timesheet_mail_manager_interval')
